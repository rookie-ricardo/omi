...
export const bashSchema: TSchema = Type.Object({
 ...
 *
 * This is useful for extensions that intercept bash commands and want to keep
 * the standard local shell behavior while still wrapping or rewriting
			...
			return new Promise((resolve, reject) => {
				...
				ops.exec(spawnContext.command, spawnContext.cwd, {
					...
					.then(({ exitCode }) => {
						...
						let details: BashToolDetails = { exitCode };
