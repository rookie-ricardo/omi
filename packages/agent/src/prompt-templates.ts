...
import { parseFrontmatter } from "@omi/tools";

const CONFIG_DIR_NAME = ".omi";
...
export interface LoadPromptTemplatesOptions {
	...
	cwd?: string;
	/** Agent config directory for global templates. Default: ~/.omi/agent/prompts */
	agentDir?: string;
...
function getPromptsDir(): string {
	const envDir = process.env.OMI_AGENT_DIR;
	if (envDir) {
	...
	return join(homedir(), ".omi", "agent", "prompts");
}
